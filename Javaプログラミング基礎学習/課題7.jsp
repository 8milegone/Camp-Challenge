...
//3000円未満購入レシートのURLは     ?zakka=雑貨&syokuhin=生鮮食品&hoka=その他&sougaku=1600&kosuu=2
    ...
    int x = (int)(p1*0.05);//intにdoubleの数値を余剰するので計算結果を整数で表示させる為に、intの変数を定義しています。
    out.println(x +"ポイント" + LINE_BREAK);}//5000円以上だと5%のポイントが付く
    
    else if (p1 >= 3000) 
    {out.println("ポイント付け率 4%");
    int o = (int)(p1*0.04);////intにdoubleの数値を余剰するので計算結果を整数で表示させる為に、intの変数を定義しています。
     out.println(o +"ポイント" + LINE_BREAK);}//3000円以上だと4%のポイントが付く
