...
if(hs.getAttribute("userdata") == null) {
      ...
      out.write("                         <a href=\"Search_category_character\">キャラクター</a> <br>\n");
      out.write("        コストパフォーマンスを重視　(金額は整数で入力して下さい)\n");
      out.write("        <form action=\"Search_category_case_price\" method=\"GET\">  \n");
      out.write("        最低金額\n");
      out.write("        <input type=\"text\" name=\"fromprice\" placeholder=\"最低金額を入力\" style=\"width:75px\">￥～<input type=\"text\" name=\"toprice\" placeholder=\"最高金額を入力\" style=\"width:75px\">￥\n");
      out.write("        <input type=\"submit\" name=\"btnSubmit\" value=\"検索\" style=\"width:35px\">\n");
      out.write("        </form> \n");
      out.write("        <br><br>\n");
      out.write("        液晶シート\n");
      out.write("        <br><br>\n");
      ...
      out.write("        <a href=\"Search_category_glass\">耐衝撃強度を重視</a> <br>\n");
      out.write("        コストパフォーマンスを重視　(金額は整数で入力して下さい)\n");
      out.write("        <form action=\"Search_category_sheet_price\" method=\"GET\"> \n");
      out.write("        最低金額\n");
      out.write("        <input type=\"text\" name=\"fromprice\" placeholder=\"最低金額を入力\" style=\"width:75px\">￥～<input type=\"text\" name=\"toprice\" placeholder=\"最高金額を入力\" style=\"width:75px\">￥\n");
      out.write("        <input type=\"submit\" name=\"btnSubmit\" value=\"検索\" style=\"width:35px\">\n");
      out.write("        </form>\n");
