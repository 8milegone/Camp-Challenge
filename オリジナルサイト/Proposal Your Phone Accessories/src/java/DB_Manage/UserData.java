...
public class UserData implements Serializable {
    ...
    private String mail;    //E-mailアドレス
    private String address; //住所
    private int total;      //購入総金額
    private Timestamp newDate;  //ユーザー登録日時
    private int deleteFlg;  //削除用フラグ
    private String terminal;//ユーザー所持端末名
    ...
    public void setUserID(String userID) {
        ...
        if(userID.equals("")) {
            ...
            this.userID = Integer.parseInt(userID);     //intに変換
        }
    }
    ...
    public void DTOUD2Mapping(UserDataDTO udd) {
        ...
        this.setTerminal(udd.getTerminal());
