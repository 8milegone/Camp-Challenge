 ...
 * @author 長島 奨
 */
public class Search_category_functionality extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //json文字列をパースしItemDataが入った配列を取得
                    ...
                    String search_method = "Search_category_functionality";
